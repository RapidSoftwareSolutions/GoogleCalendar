...
$app->post('/api/GoogleCalendar/updateCalendarListEntry', function ($request, $response) {
    ...
    $requiredParams = ['accessToken'=>'accessToken','calendarId'=>'calendarId','defaultReminders'=>'defaultReminders','id'=>'id','notifications'=>'notifications'];
    ...
    $query_str = "https://www.googleapis.com/calendar/v3/users/me/calendarList/{$data['calendarId']}";
